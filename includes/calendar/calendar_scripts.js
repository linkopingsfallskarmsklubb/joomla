  ...
  if (buttons) {
    html +=  "<div class='calendar_nav'> \
                <div class='calendar_nav_left'> \
                  <div class='calendar_nav_img_cent'><img src='" + CCM_REL + "/single_pages/includes/calendar/arrow_left.png' alt='Prev' /> \
                  </div> \
                </div> \
                <div class='calendar_nav_date'> \
                </div> \
                <div class='calendar_nav_right'> \
                  <div class='calendar_nav_img_cent'><img src='" + CCM_REL + "/single_pages/includes/calendar/arrow_right.png' alt='Next' /> \
                  </div> \
                </div>";
  }
